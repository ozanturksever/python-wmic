...
rsync -a --exclude=.git --exclude=debian/ --exclude=.idea --exclude=.DS_Store ${repository_directory}/pysamba/ ${package_directory}/usr/local/python2.7/pysamba
rsync -a --exclude=.git --exclude=debian/ --exclude=.idea --exclude=.DS_Store ${repository_directory}/zenoss_utils/ ${package_directory}/usr/local/python2.7/zenoss_utils
